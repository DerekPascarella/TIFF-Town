...
if [ -f "src/TiffTown.App/Info.plist" ]; then
    cp "src/TiffTown.App/Info.plist" "${BUNDLE_PATH}/Contents/Info.plist"
    ...
    echo "Warning: Info.plist template not found at src/TiffTown.App/Info.plist"
fi
...
if [ -f "src/TiffTown.App/Assets/icon.icns" ]; then
    cp "src/TiffTown.App/Assets/icon.icns" "${BUNDLE_PATH}/Contents/Resources/"
